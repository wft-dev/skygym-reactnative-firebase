...
const Example = () => (
  <Router createReducer={reducerCreate} onStateChange={stateHandler} getSceneStyle={getSceneStyle} uriPrefix={prefix}>
    <Overlay key="overlay">
      <Modal key="modal" hideNavBar transparent={true} transitionConfig={() => console.log('hjhjh')}>
              ...
              <Scene hideNavBar panHandlers={null}>
                ...
                >
                  ...
                  <Stack key="tab_2" title="Tab #2" icon={TabIcon} initial>
                    <Scene key="tab_2_1" component={TabView} title="Tab #2_1" renderRightButton={() => <Text>Right2</Text>} leftButtonIconStyle = {{ alignSelf: 'center', marginLeft: 20 }} />
