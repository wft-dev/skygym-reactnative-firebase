...
export default function styles(props, showMemberShipPlan) {
  console.log('------------sate-', showMemberShipPlan)
  return (StyleSheet.create({
    ...
    profileBtnView: {
      ...
      paddingVertical: getOrientation() === "portrait" ? hp('1.5%') : wp('1.5%'),
      backgroundColor: !showMemberShipPlan ? Colors.yellowAlphaLight : Colors.white,
      alignItems: 'center',
