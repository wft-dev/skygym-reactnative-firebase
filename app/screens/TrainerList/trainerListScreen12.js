...
class trainerListScreen12 extends Component {
    state = {
        showSearch: false,
        showFilter: false,
        ...
        return (
            ...
            <View style={mainViewSt}>
                ...
                <View style={containerMainSt}>
                    ...
                    <View style={marginListView}>
                        <CustomList isTrainer={true} />
                    </View>
                </View>
                <FloatingButton onPressPlusBtn={this.naviagteToAddTrainerScreen} />
            </View>
            // </SafeAreaView>
        );
    }
...
export default trainerListScreen12;
